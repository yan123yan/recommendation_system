...
def getRatings(file_path):
    ...
    plt.bar(scores.keys(), scores.values, fc="orange", tick_label=scores.keys())
    plt.xlabel("Rating score")
    plt.ylabel("number of user")
    plt.title("User's Rating")
    plt.show()
